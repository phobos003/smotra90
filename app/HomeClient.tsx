...
{q:"Что делать если плохая погода?", a:"Дождь или снег не мешают посещению — благодаря панорамным окнам пространство остаётся комфортным, а вид становится более атмосферным. При сильном тумане видимость может быть ограничена, однако площадка остаётся полноценным местом для отдыха с продуманной атмосферой внутри."},
...
{q:"Сколько длится посещение?", a:"Время посещения не ограничено. В среднем гости проводят на площадке 1–2 часа. Экскурсия с гидом длится около 20 минут."},
